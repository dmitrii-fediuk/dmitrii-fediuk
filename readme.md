...
🔸 **114** items in my [Upwork portfolio](https://www.upwork.com/fl/mage2pro)  
🔸 Master of Science in **Computer Science** and **Mathematics**, specializing in **AI**  
🔸 **AI** / **My methodology**   
🔅 I avoid natural language queries to LLMs.   
Instead, I have developed my own [formal language](https://github.com/dmitrii-fediuk-ai/o/blob/main/_Generic/_Primary/L.md) to construct [ontologies](https://en.wikipedia.org/wiki/Ontology_(information_science)) and execute subsequent ontology-based queries to LLMs.  
...
https://www.google.com/search?q=Calcium+D-Pantothenate+site:pubmed.ncbi.nlm.nih.gov&pws=0&gl=US)
  ...
  - [Grifola frondosa](https://www.google.com/search?q=Grifola+frondosa+site:pubmed.ncbi.nlm.nih.gov&pws=0&gl=US)
